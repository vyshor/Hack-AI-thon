...
# ==============================================================================
"""SSD Feature Pyramid Network (FPN) feature extractors based on Resnet v2.
...
class _SSDResnetV2FpnFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    super(_SSDResnetV2FpnFeatureExtractor, self).__init__(
      ...
      with slim.arg_scope(self._conv_hyperparams_fn()):
        with tf.variable_scope(self._fpn_scope_name,
          ...
          fpn_features = feature_map_generators.fpn_top_down_feature_maps(
              ...
              depth=self._additional_layer_depth, use_explicit_padding=False)
          feature_maps = []
          for level in range(self._fpn_min_level, base_fpn_max_level + 1):
            feature_maps.append(
...
class SSDResnet50V2FpnFeatureExtractor(_SSDResnetV2FpnFeatureExtractor):
  """SSD Resnet50 V2 FPN feature extractor."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDResnet50V2FpnFeatureExtractor, self).__init__(
        is_training,
        depth_multiplier,
        min_depth,
        pad_to_multiple,
...
class SSDResnet101V2FpnFeatureExtractor(_SSDResnetV2FpnFeatureExtractor):
  """SSD Resnet101 V2 FPN feature extractor."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDResnet101V2FpnFeatureExtractor, self).__init__(
        is_training,
        depth_multiplier,
        min_depth,
        pad_to_multiple,
...
class SSDResnet152V2FpnFeatureExtractor(_SSDResnetV2FpnFeatureExtractor):
  """SSD Resnet152 V2 FPN feature extractor."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDResnet152V2FpnFeatureExtractor, self).__init__(
        is_training,
        depth_multiplier,
        min_depth,
        pad_to_multiple,
